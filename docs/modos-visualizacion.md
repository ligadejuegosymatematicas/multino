...
Cambiar de renderer no baraja, reparte, juega, pasa, puntúa ni modifica el turno. La preferencia visual pertenece a UI o configuración local del usuario, no a `config` reglamentaria ni al snapshot v5.
