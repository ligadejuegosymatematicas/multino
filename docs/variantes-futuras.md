...
Esto no requiere generalizar ahora el snapshot v6. La puntuación aprobada concentra el literal 5 dentro del módulo de puntuación, en vez de dispersarlo por tablero, UI e historial.
